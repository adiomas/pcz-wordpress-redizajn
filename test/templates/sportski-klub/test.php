<?php
/**
 * Test Wrapper za "Sportski Klub" komponentu
 * 
 * Testira sportski-klub/sportski-klub.php komponentu s mock podacima
 * 
...
// =============================================================================
// SET BRAND CONTEXT - Sportski Klub test always uses sportski-klub brand
// =============================================================================

pcz_set_current_brand('sportski-klub');

// Set visibility class for components that check it
$visibility_class = 'pcz-sportski-klub--visible';
...
$current_template = $GLOBALS['pcz_current_template'] ?? 'sportski-klub';
...
$component_name = 'Sportski Klub';
$component_path = pcz_PROJECT_ROOT . '/sportski-klub/sportski-klub.php';
$component_css  = '/sportski-klub/sportski-klub.css';
    ...
    <style>
        ...
        * {
        ...
        /* =======================================================
           ...
           /sportski-klub/sportski-klub.css (bez !important)
...
<div class="test-preview" id="test-preview">
    ...
    <!-- Mock Hero Section -->
    <div style="background: linear-gradient(135deg, #FF6B00 0%, #ff8533 100%); padding: 120px 40px 80px; text-align: center;">
        <h1 style="color: white; font-size: clamp(2rem, 6vw, 3.5rem); font-weight: 900; text-transform: uppercase; letter-spacing: 4px; margin: 0 0 20px;">Sportski Klub</h1>
        <p style="color: rgba(255,255,255,0.9); font-size: 1.1rem; max-width: 600px; margin: 0 auto;">Plesni Centar Zagreb - Natjecateljski program</p>
    </div>
    
    <!-- ==================== -->
    <!-- SPORTSKI KLUB COMPONENT -->
    <!-- ==================== -->
    ...
    <div class="test-content">
        ...
        <p>Ovo je mock sadržaj koji simulira ostatak stranice ispod "Sportski Klub" sekcije. Ovdje bi mogla doći prijava forma ili neka druga sekcija.</p>
    </div>
...
(function() {
    ...
    console.log('Current template: sportski-klub');
