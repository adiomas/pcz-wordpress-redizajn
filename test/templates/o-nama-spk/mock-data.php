...
return [
    ...
    'acf_fields' => [
        ...
        // Naslov akcent (italic outline)
        'spk_onama_naslov_akcent' => '& našoj priči',
...
<p>Natječu se u više starosnih razreda, od mlađih osnovaca do veterana.</p>',
    ...
    'scenarios' => [
        ...
        // Bez slike (testira tamnu pozadinu)
        'no_image' => [
            'acf_fields' => [
                'spk_onama_slika' => '',
            ],
        ...
        'alt_title' => [
            'acf_fields' => [
                ...
                'spk_onama_naslov_akcent' => '& tradicija',
            ],
        ],
